        ...
        projs: [
            {
                ...
                projs: [
					...
					<p><i>I’ve also created an extensive document to help me guide my skeptical colleagues, who are Microsoft stack developers, to build the environment needed to deploy a .NET 8 microservice to AWS Lambda Serverless Function, using a Ubuntu/Linux distribution and the cost-effective Graviton processor based in the Arm64 architecture. Along this process, I realized that the installation and the related configuration using this architecture was a sort of problematic depending on the installation pathway chosen. So, I decided to describe the solutions that worked better for our development context and maybe could also help someone else outside our playground. My colleagues, who were once resistant, now are engaged and using this DevContainer development concept. To support some tasks presented in this guide, I've created some bash scripts running .NET CLI and AWS CLI commands. If you are interested, you can open this guide by <a target="_blank" href="https://docs.google.com/document/d/1Yg7iscwM2IChCxy66aYhOB4-kA_9cgu6XC3Ar5RNn5k/edit?usp=sharing">clicking here</a></i>.</p>
...
<img src="assets/img/pcb/PCBLogo.jpg" alt="company logo" /></div>`},
    ...
    const data = {
        skills: [
			...
			'.NET CLI, AWS.CLI',
			'Docker Container, AWS Lambda Serverless Function, AWS S3 Bucket, AWS Event Bridge',
